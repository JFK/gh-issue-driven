...
| `/gh-issue-driven:review [flags]` | 2 | **Canonical home of the post-PR review loop** — drive (or re-run) review on an already-open PR (Copilot, `/code-review`, or both, per `review.provider`). Re-entrant by design. Flags: `dry-run`, `force`. |
